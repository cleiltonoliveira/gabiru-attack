/**
 * @author cleilton
 * File: MapObject.java - Date: Dec 11, 2019
 */
package entity;
...
public abstract class MapObject {
	...
	public void calculateCorners(double x, double y) {
		...
		// (x, ydest)
		int leftTile = (int) (x - cwidth / 2) / tileSize; // find the left tile column
		int rightTile = (int) (x + cwidth / 2 - 1) / tileSize; // find the right tile column
